...
$query = "SELECT return_transaction.Trans_id, return_transaction.Anggota_id, nama, Date_of_load, return_transaction.Return_date, Fine FROM borrow_transaction join anggota on borrow_transaction.Anggota_id = anggota.username join return_transaction on anggota.username = return_transaction.Anggota_id order by return_transaction.Trans_id;";
